...
while True:
	...
	if playerPosY > (stageHeight) - circleRadius_1: playerPosY = stageHeight - circleRadius_1 
	if playerPosY < circleRadius_1: playerPosY = circleRadius_1 
	if playerPosY < startScrollingPosY: circlePosY = playerPosY 
	elif playerPosY > stageHeight - startScrollingPosY: circlePosY = playerPosY - stageHeight + H
	else:
	...
	pygame.draw.circle(DS, WHITE, (int(circlePosX), playerPosY - 25), circleRadius_1, 0)
